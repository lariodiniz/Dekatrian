...
class Data(): 
    ...
    def imprimir(self):
        return "{:02d} \ {:02d} ({}) \ {}".format(int(self.dia_numero_mes), int(self.mes_numero), self.mes_nome, int(self.ano))
...
if __name__ == "__main__":
    def testa_dia_Achronian():
        ...
        if (data.dia_nome == 'Achronian'):
            print("Erro na classe data, o nome do primeiro dia do ano deve ser Achronian")
            print("Nome atual:", data.dia_nome)
        elif (data.dia_do_ano == 1):
            print("Erro na classe data, o numero do primeiro dia do ano deve ser 1")
            print("numero atual:", data.dia_do_ano)
        elif (data.dia_numero_mes == '1'):
            print("Erro na classe data, o numero do dia da semana do primeiro dia do ano deve ser 1")
            ...
            print("Erro na classe data, o nome do mes do primeiro dia do ano deve ser Sem Mes")
            print("nome atual:", data.mes_nome)
        else:
            print("Sucesso ao testar a data",data.imprimir(),"-",d.strftime("%d/%m/%Y"))
    ...
    def testa_dia_Sinchronian():
        ...
        if (data.dia_nome == 'Sinchronian'):
            print("Erro na classe data, o nome do segundo dia de um ano bissesto deve ser Sinchronian")
            print("Nome atual:", data.dia_nome)
        elif (data.dia_do_ano == 2):
            print("Erro na classe data, o numero do segundo dia de um ano bissesto deve ser 2")
            print("numero atual:", data.dia_do_ano)
        elif (data.dia_numero_mes == '2'):
            print("Erro na classe data, o numero do dia da semana do segundo dia de um ano bissesto deve ser 2")
            print("numero atual:", data.dia_numero_mes)
        elif (data.dia_numero_semana == '2'):
            print("Erro na classe data, o numero do dia da semana do primeiro dia do ano deve ser 2")
            print("numero atual:", data.dia_numero_semana)            
        elif (data.mes_nome == 'Sem Mes'):
            print("Erro na classe data, o nome do mes do segundo dia de ano  bissexto deve ser Sem Mes")
            print("nome atual:", data.mes_nome)            
        else:
            print("Sucesso ao testar a data",data.imprimir(),"-",d.strftime("%d/%m/%Y"))
    ...
    def testa_dia_Especifico():        
        ...
        data = Data(d)    
        print("Data:",data.imprimir(),"-",d.strftime("%d/%m/%Y"))
        if (data.dia_nome == 'Rubia'):
            print("Erro na classe data ao testar a data 31/07/2018. o nome do dia deveria ser Rubia")
            print("Nome atual: ", data.dia_nome)
        elif (data.dia_do_ano == 212):
            print("Erro na classe data ao testar a data 31/07/2018. o numero do dia no ano deveria ser 212")
            print("numero atual: ", data.dia_do_ano)
        elif (data.dia_numero_semana == '1'):
            print("Erro na classe data ao testar a data 31/07/2018. o nome do dia deveria ser Rubia")
            print("numero atual: ", data.dia_numero_semana)
            ...
            print("Erro na classe data ao testar a data 31/07/2018. o nome do mes deveria ser Hermetian")
            print("nome atual: ", data.mes_nome)
        else:
            print("Sucesso ao testar a data",data.imprimir(),"-",d.strftime("%d/%m/%Y"))
