...
class Dia():
    @staticmethod
    def nomes():
        return ('Rubia', 'Auria', 'Flavia', 'Virdia',
                'Coria', 'India', 'Violeta')
...
if __name__ == "__main__":
    ...
    def testa_nomes_dos_dias():
        nomes = Dia.nomes()
        nomes_corretos = ('Rubia', 'Auria', 'Flavia', 'Virdia',
                          'Coria', 'India', 'Violeta')
    ...
    def testa_dia_Achronian():
        ...
        if (dia.nome != 'Achronian'):
            print("Erro na classe dia, ao receber o parametro 0 o nome do dia",
                  "deve ser Achronian")
            print("Nome atual: ", dia.nome)
        elif (dia.numero_mes == '1'):
            print("Erro na classe dia, ao receber o parametro 0 o numero do",
                  "dia no mes deve do dia ser 1.")
    ...
    def testa_dia_Sinchronian():
        ...
        if (dia.nome != 'Sinchronian'):
            print("Erro na classe dia, ao receber o parametro -1 o nome do",
                  "dia deve ser Sinchronian")
            print("Nome atual: ", dia.nome)
        elif (dia.numero_mes == '2'):
            print("Erro na classe dia, ao receber o parametro -1 o numero do",
                  "dia no mes deve do dia ser 2.")
            print("numero atual: ", dia.numero_mes)
        else:
    ...
    def testa_dia_Semana():
        for n in range(1, 29):
            ...
            if (dia.nome != nome):
                print("Erro na classe dia, ao receber o parametro",
                      n,
                      "o nome do dia deve ser",
                      nome)
                print("Nome atual: ", dia.nome)
                break
                ...
                print("Erro na classe dia, ao receber o parametro",
                      n,
                      "o numero do dia no mes deve ser",
                      n)
                ...
                print("Erro na classe dia, ao receber o parametro",
                      n,
                      "o numero do dia da semana deve ser",
                      dia_da_semana)
